            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form action="{{ route('training-categories.update', $training_category->id) }}" method="POST" data-parsley-validate data-parsley-focus="first">
                            @csrf
                            @method('put')
                            <div class="row ">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $training_category->name }}" placeholder="Enter Training Category Name" required=""/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" id="status" name="status" required>
                                            <option value="1" {{ $training_category->status == "1" ? 'selected' : null }}>Active</option>
                                            <option value="0" {{ $training_category->status == "0" ? 'selected' : null }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
