<div class="card">
    ...
    <div class="card-block">
        <form action="{{ route('how_it_work_page_post') }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
            @csrf
            <input type="hidden" name="section_title" value="step_one">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label" for="step_title">Step Tilte <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="step_title" name="step_title" value="{{ $step_one ? $step_one->step_title : old('step_title') }}" required/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label" for="main_title">Main Tilte <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="main_title" name="main_title" value="{{ $step_one ? $step_one->main_title : old('main_title') }}" required/>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" rows="8" id="content" name="content" required >{{ $step_one ? $step_one->content : old('content') }}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-default-file="{{ $step_one && $step_one->section_image != null ? asset('uploaded_files/images/pages/how_it_work_page/'.$step_one->section_image) : null }}"/>
                    </div>
                </div>
            </div>
            <div class="row ">
