            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        data-default-file="{{ $section_four && $section_four->decoration_one_image != null ? asset('uploaded_files/images/pages/home_page/'.$section_four->decoration_one_image) : null }}"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        data-default-file="{{ $section_four && $section_four->decoration_two_image != null ? asset('uploaded_files/images/pages/home_page/'.$section_four->decoration_two_image) : null }}"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        data-default-file="{{ $section_four && $section_four->decoration_three_image != null ? asset('uploaded_files/images/pages/home_page/'.$section_four->decoration_three_image) : null }}"/>
                    </div>
                </div>
            </div>
            <div class="row ">
