            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="sub_title" name="sub_title" required >{{ $section_two ? $section_two->sub_title : old('sub_title') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label" for="section_image">Section Image <span class="text-danger">*</span> <span class="text-info">( Recommended Size: 704px X 354px )</span></label>
                        ...
                        data-default-file="{{ $section_two && $section_two->section_image != null ? asset('uploaded_files/images/pages/home_page/'.$section_two->section_image) : null }}"/>
                    </div>
                </div>
            </div>
            <div class="row ">
