            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form action="{{ route('training-exams.store') }}" method="POST" data-parsley-validate data-parsley-focus="first">
                            @csrf
                            <div class="row ">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="test_title">Video Title <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="test_title" name="test_title" value="{{ old('test_title') }}" placeholder="Enter Exam Title" required=""/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" class="form-control" id="time_limit" name="time_limit" value="{{ old('time_limit') }}" placeholder="Enter Time Limit"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="number_of_question">Number of Question</label>
                                        <input type="number" min="0" class="form-control" id="number_of_question" name="number_of_question" value="{{ old('number_of_question') }}" placeholder="Enter Number of Question"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="marks_per_question">Marks per Question</label>
                                        <input type="text" class="form-control" id="marks_per_question" name="marks_per_question" value="{{ old('marks_per_question') }}" placeholder="Enter Marks per Question"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row ">
