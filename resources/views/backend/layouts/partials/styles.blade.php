...
<!-- Required Fremwork -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">
<!-- themify icon -->
...
<!-- Menu-Search css -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/assets/pages/menu-search/css/component.css') }}">
<!-- Horizontal-Timeline css -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/assets/pages/dashboard/horizontal-timeline/css/style.css') }}">
<!-- amchart css -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/assets/pages/dashboard/amchart/css/amchart.css') }}">
<!-- Data Table Css -->
...
<!-- Parsley CSS -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/assets/pages/parsley/parsley.css') }}">
<!-- Parsley CSS -->

<!-- Toaster CSS -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/assets/pages/toaster/toastr.min.css') }}">
<!-- Toaster CSS -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/assets/pages/select2/select2.min.css') }}">
<!-- flag icon framework css -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/assets/pages/flag-icon/flag-icon.min.css') }}">
<!-- Style.css -->
