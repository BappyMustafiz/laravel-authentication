...
Route::get('/', [HomeController::class, 'customerLogin'])->name('customer-login');
Route::get('/customer-register', [HomeController::class, 'customerRegister'])->name('customer-register');
